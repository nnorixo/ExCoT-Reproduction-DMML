### Vom Original. Leicht angepasst. Hat am Ende nicht funktioniert, weil vllm, torch, python etc unterschiedliche Versionen haben, die nicht zusammen funktioniert haben -.-
